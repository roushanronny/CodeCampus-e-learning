      ...
      <div>
        ...
        <div className='lg:p-10 md:p-7 pt-7 sm:p-8 w-full'>
          ...
          <div className='flex items-center justify-between px-10 flex-wrap'>
            {Array.from({ length: Math.max(0, Math.min(6, 100)) }).map((_, index) => (
      ...
      <div className='lg:p-10 md:p-7 pt-7 sm:p-8 w-full'>
        ...
        <div className='flex items-center justify-between px-10 flex-wrap'>
          {trendingCourses?.slice(0, cardsToShow).map((course) => {
            return (
              <div key={course._id} className='grid  md:m-5 my-6  justify-center overflow-hidden text-center  bg-red-200 rounded-lg'>
