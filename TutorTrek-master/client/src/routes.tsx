...
import StudentChannels from "./components/pages/channel/student-channels";
import Settings from "./components/pages/student-dash/settings";
...
const LazyViewStudentProfile = lazy(
  () => import("./components/pages/instructors/view-student-profile")
);
