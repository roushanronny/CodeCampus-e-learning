...
const AboutUs: React.FC = () => {
  return (
    <div className=' p-12'>
      <h1 className='text-3xl ml-5 font-semibold mb-4'>About CodeCampus</h1>
      <div className='flex flex-col md:flex-row space-x-0 md:space-x-8'>
        <div className='md:w-1/2 ml-5 '>
          <img
            ...
            alt='About CodeCampus'
            className='rounded-lg  w-10/12 shadow-md'
          />
        </div>
        <div className='md:w-1/2 mt-5 md:mt-0'>
          <p className='text-gray-600 mb-4'>
            Welcome to <span className='font-semibold'>CodeCampus</span>, your ultimate
            destination for online learning and growth. We're on a mission to
            bring education to your fingertips, connecting passionate teachers
            with eager learners from around the world.
          </p>
          <p className='text-gray-600 mb-4'>
            ...
            advancing your career, CodeCampus provides you with a dynamic
          ...
          <p className='text-gray-600'>
            Join <span className='font-semibold'>CodeCampus</span> today and embark on a journey
            of knowledge, empowerment, and connection. Let's explore, learn,
            and grow together!
          </p>
        </div>
      </div>
